...
typedef NS_ENUM(NSInteger, PAZNTKKitCropAreaCornerStyle) {
    PAZNTKKitCropAreaCornerStyleRightAngle,
    PAZNTKKitCropAreaCornerStyleCircle
};
@interface PAZNTKCropImageView : UIView

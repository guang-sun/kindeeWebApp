...
@class PAFSCalendar, PAFSCalendarAppearance, PAFSCalendarEventIndicator;

typedef NS_ENUM(NSUInteger, PAFSCalendarMonthPosition);

@interface PAFSCalendarCell : UICollectionViewCell
 ...
 */
@property (weak, nonatomic) PAFSCalendarEventIndicator *eventIndicator;
...
@property (weak, nonatomic) PAFSCalendarAppearance *appearance;

@property (strong, nonatomic) NSString *subtitle;
@property (strong, nonatomic) UIImage  *image;
@property (assign, nonatomic) PAFSCalendarMonthPosition monthPosition;
...
@interface PAFSCalendarEventIndicator : UIView
...
@interface PAFSCalendarBlankCell : UICollectionViewCell

 ...
 */
FOUNDATION_EXPORT NSString * _Nullable PAZNSDTransformedKeyForKey(NSString * _Nullable key, NSString * _Nonnull transformerKey);

/**
 A transformer protocol to transform the image load from cache or from download.
 You can provide transformer to cache and manager (Through the `transformer` property or context option `PAZNSDWebImageContextImageTransformer`).
 
 @note The transform process is called from a global queue in order to not to block the main queue.
 */
@protocol PAZNSDImageTransformer <NSObject>
 ...
 */
@interface PAZNSDImagePipelineTransformer : NSObject <PAZNSDImageTransformer>

/**
 All transformers in pipeline
 */
@property (nonatomic, copy, readonly, nonnull) NSArray<id<PAZNSDImageTransformer>> *transformers;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithTransformers:(nonnull NSArray<id<PAZNSDImageTransformer>> *)transformers;
 ...
 */
@interface PAZNSDImageRoundCornerTransformer: NSObject <PAZNSDImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) PAZNSDRectCorner corners;
...
- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithRadius:(CGFloat)cornerRadius corners:(PAZNSDRectCorner)corners borderWidth:(CGFloat)borderWidth borderColor:(nullable UIColor *)borderColor;
 ...
 */
@interface PAZNSDImageResizingTransformer : NSObject <PAZNSDImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) PAZNSDImageScaleMode scaleMode;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithSize:(CGSize)size scaleMode:(PAZNSDImageScaleMode)scaleMode;
 ...
 */
@interface PAZNSDImageCroppingTransformer : NSObject <PAZNSDImageTransformer>
 ...
 */
@interface PAZNSDImageFlippingTransformer : NSObject <PAZNSDImageTransformer>
 ...
 */
@interface PAZNSDImageRotationTransformer : NSObject <PAZNSDImageTransformer>
 ...
 */
@interface PAZNSDImageTintTransformer : NSObject <PAZNSDImageTransformer>
 ...
 */
@interface PAZNSDImageBlurTransformer : NSObject <PAZNSDImageTransformer>
 ...
 */
@interface PAZNSDImageFilterTransformer: NSObject <PAZNSDImageTransformer>

...
/**
 * Integrates PAZNSDWebImage async downloading and caching of remote images with NSButton.
 */
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSURL *PAZNSD_currentImageURL;
 ...
 */
- (void)pa_setImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT;
 ...
 * @see pa_setImageWithURL:placeholderImage:options:
 */
- (void)pa_setImageWithURL:(nullable NSURL *)url
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSURL *PAZNSD_currentAlternateImageURL;
 ...
 */
- (void)PAZNSD_setAlternateImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT;
 ...
 * @see PAZNSD_setAlternateImageWithURL:placeholderImage:options:
 */
- (void)PAZNSD_setAlternateImageWithURL:(nullable NSURL *)url
                   placeholderImage:(nullable UIImage *)placeholder NS_REFINED_FOR_SWIFT;
 ...
 * @param url         The url for the alternateImage.
 * @param placeholder The alternateImage to be set initially, until the alternateImage request finishes.
 * @param options     The options to use when downloading the alternateImage. @see PAZNSDWebImageOptions for the possible values.
 */
- (void)PAZNSD_setAlternateImageWithURL:(nullable NSURL *)url
                   placeholderImage:(nullable UIImage *)placeholder
                            options:(PAZNSDWebImageOptions)options NS_REFINED_FOR_SWIFT;
 ...
 */
- (void)PAZNSD_cancelCurrentAlternateImageLoad;

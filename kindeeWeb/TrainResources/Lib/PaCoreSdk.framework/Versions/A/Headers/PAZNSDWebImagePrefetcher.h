...
@class PAZNSDWebImagePrefetcher;

/**
 A token represents a list of URLs, can be used to cancel the download.
 */
@interface PAZNSDWebImagePrefetchToken : NSObject <PAZNSDWebImageOperation>
 ...
 */
@protocol PAZNSDWebImagePrefetcherDelegate <NSObject>
 ...
 */
- (void)imagePrefetcher:(nonnull PAZNSDWebImagePrefetcher *)imagePrefetcher didPrefetchURL:(nullable NSURL *)imageURL finishedCount:(NSUInteger)finishedCount totalCount:(NSUInteger)totalCount;
 ...
 */
- (void)imagePrefetcher:(nonnull PAZNSDWebImagePrefetcher *)imagePrefetcher didFinishWithTotalCount:(NSUInteger)totalCount skippedCount:(NSUInteger)skippedCount;

@end

typedef void(^PAZNSDWebImagePrefetcherProgressBlock)(NSUInteger noOfFinishedUrls, NSUInteger noOfTotalUrls);
typedef void(^PAZNSDWebImagePrefetcherCompletionBlock)(NSUInteger noOfFinishedUrls, NSUInteger noOfSkippedUrls);

/**
 * Prefetch some URLs in the cache for future use. Images are downloaded in low priority.
 */
@interface PAZNSDWebImagePrefetcher : NSObject
 ...
 */
@property (strong, nonatomic, readonly, nonnull) PAZNSDWebImageManager *manager;
...
/**
 * The options for prefetcher. Defaults to PAZNSDWebImageLowPriority.
 */
@property (nonatomic, assign) PAZNSDWebImageOptions options;

/**
 * The context for prefetcher. Defaults to nil.
 */
@property (nonatomic, copy, nullable) PAZNSDWebImageContext *context;
 ...
 */
@property (weak, nonatomic, nullable) id <PAZNSDWebImagePrefetcherDelegate> delegate;

/**
 * Returns the global shared image prefetcher instance. It use a standalone manager which is different from shared manager.
 */
@property (nonatomic, class, readonly, nonnull) PAZNSDWebImagePrefetcher *sharedImagePrefetcher;

/**
 * Allows you to instantiate a prefetcher with any arbitrary image manager.
 */
- (nonnull instancetype)initWithImageManager:(nonnull PAZNSDWebImageManager *)manager NS_DESIGNATED_INITIALIZER;

/**
 * Assign list of URLs to let PAZNSDWebImagePrefetcher to queue the prefetching. It based on the image manager so the image may from the cache and network according to the `options` property.
 ...
 */
- (nullable PAZNSDWebImagePrefetchToken *)prefetchURLs:(nullable NSArray<NSURL *> *)urls;
 ...
 */
- (nullable PAZNSDWebImagePrefetchToken *)prefetchURLs:(nullable NSArray<NSURL *> *)urls
                                          progress:(nullable PAZNSDWebImagePrefetcherProgressBlock)progressBlock
                                         completed:(nullable PAZNSDWebImagePrefetcherCompletionBlock)completionBlock;

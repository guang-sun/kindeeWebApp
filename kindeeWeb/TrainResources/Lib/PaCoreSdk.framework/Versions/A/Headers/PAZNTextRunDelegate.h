...
/**
 ...
 Example:
     ...
     PAZNTextRunDelegate *delegate = [PAZNTextRunDelegate new];
     delegate.ascent = 20;
     delegate.descent = 4;
     delegate.width = 20;
...
/**
 ...
 The CTRunDelegateRef has a strong reference to this PAZNTextRunDelegate object.
 In CoreText, use CTRunDelegateGetRefCon() to get this PAZNTextRunDelegate object.

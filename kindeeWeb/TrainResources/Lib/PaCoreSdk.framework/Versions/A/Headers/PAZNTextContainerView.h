...
/**
 A simple view to diaplay `PAZNTextLayout`.
...
@property (nullable, nonatomic, strong) PAZNTextLayout *layout;
...
- (void)setLayout:(nullable PAZNTextLayout *)layout withFadeDuration:(NSTimeInterval)fadeDuration;

...
/**
 * Integrates PAZNSDWebImage async downloading and caching of remote images with UIButton.
 */
 ...
 */
- (nullable NSURL *)PAZNSD_imageURLForState:(UIControlState)state;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSURL *PAZNSD_currentBackgroundImageURL;
 ...
 * @param state Which state you want to know the URL for. The values are described in UIControlState.
 */
- (nullable NSURL *)PAZNSD_backgroundImageURLForState:(UIControlState)state;
 ...
 * @param state The state that uses the specified title. The values are described in UIControlState.
 */
- (void)PAZNSD_setBackgroundImageWithURL:(nullable NSURL *)url
                            forState:(UIControlState)state NS_REFINED_FOR_SWIFT;
 ...
 */
- (void)PAZNSD_cancelImageLoadForState:(UIControlState)state;

/**
 * Cancel the current backgroundImage download
 */
- (void)PAZNSD_cancelBackgroundImageLoadForState:(UIControlState)state;

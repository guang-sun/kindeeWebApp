...
/**
 The PAZNLabel class implements a read-only text view.
 ...
 */
@interface PAZNLabel : UIView <NSCoding>
...
/**
 The text vertical aligmnent in container. Default is PAZNTextVerticalAlignmentCenter.
 */
 ...
 */
@property (nullable, nonatomic, strong) PAZNTextLayout *textLayout;
...
/**
 ...
 The default value is nil.
 */
@property (nullable, nonatomic, copy) PAZNTextAction textTapAction;

/**
 When user long press the label, this action will be called (similar to long press gesture).
 The default value is nil.
 */
@property (nullable, nonatomic, copy) PAZNTextAction textLongPressAction;

/**
 When user tap the highlight range of text, this action will be called.
 The default value is nil.
 */
@property (nullable, nonatomic, copy) PAZNTextAction highlightTapAction;

/**
 When user long press the highlight range of text, this action will be called.
 The default value is nil. 
 */
@property (nullable, nonatomic, copy) PAZNTextAction highlightLongPressAction;
...
/*
 ...
 3. If you want to get the highest performance, you should do text layout with
    `PAZNTextLayout` class in background thread. Here's an example:
    
    PAZNLabel *label = [PAZNLabel new];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        text.pazn_font = [UIFont systemFontOfSize:16];
        text.pazn_color = [UIColor grayColor];
        [text pazn_setColor:[UIColor redColor] range:NSMakeRange(0, 4)];
 
        // Create text container
        PAZNTextContainer *container = [PAZNTextContainer new];
        container.size = CGSizeMake(100, CGFLOAT_MAX);
        container.maximumNumberOfRows = 0;
        
        // Generate a text layout.
        PAZNTextLayout *layout = [PAZNTextLayout layoutWithContainer:container text:text];
...
@property (nonatomic) UIEdgeInsets textContainerInset;
@property (nullable, nonatomic, copy) id<PAZNTextLinePositionModifier> linePositionModifier;
@property (nonnull, nonatomic, copy) PAZNTextDebugOption *debugOption;
@property (nullable, nonatomic, copy) PAZNTextAction textTapAction;
@property (nullable, nonatomic, copy) PAZNTextAction textLongPressAction;
@property (nullable, nonatomic, copy) PAZNTextAction highlightTapAction;
@property (nullable, nonatomic, copy) PAZNTextAction highlightLongPressAction;

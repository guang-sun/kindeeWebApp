...
/**
 The PAZNTextParser protocol declares the required method for PAZNTextView and PAZNLabel
 to modify the text during editing.
 
 You can implement this protocol to add code highlighting or emoticon replacement for
 PAZNTextView and PAZNLabel. See `PAZNTextSimpleMarkdownParser` and `PAZNTextSimpleEmoticonParser` for example.
 */
@protocol PAZNTextParser <NSObject>
@required
/**
 When text is changed in PAZNTextView or PAZNLabel, this method will be called.
 ...
 no selected range (such as PAZNLabel), this value is NULL.
 ...
 */
@property (nullable, copy) NSDictionary<NSString *, UIImage *> *emoticonMapper;
@end

...
/**
 PAZNTextTransaction let you perform a selector once before current runloop sleep.
 */
 ...
 */
+ (PAZNTextTransaction *)transactionWithTarget:(id)target selector:(SEL)selector;

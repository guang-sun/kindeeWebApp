...
//  PAZNEmptyDataSet
//  https://github.com/dzenbot/PAZNEmptyDataSet
//
//  Created by Ignacio Romero Zurbuchen on 6/20/14.
//  Copyright (c) 2016 PAZN Labs. All rights reserved.
//  Licence: MIT-Licence
//
...
@protocol PAZNEmptyDataSetSource;
@protocol PAZNEmptyDataSetDelegate;

/**
 A drop-in UITableView/UICollectionView superclass category for showing empty datasets whenever the view has no content to display.
 @discussion It will work automatically, by just conforming to PAZNEmptyDataSetSource, and returning the data you want to show.
 */
@interface UIScrollView (PAZNEmptyDataSet)

/** The empty datasets data source. */
@property (nonatomic, weak, nullable) IBOutlet id <PAZNEmptyDataSetSource> pa_emptyDataSetSource;
/** The empty datasets delegate. */
@property (nonatomic, weak, nullable) IBOutlet id <PAZNEmptyDataSetDelegate> pa_emptyDataSetDelegate;
/** YES if any empty dataset is visible. */
@property (nonatomic, readonly, getter = pa_isEmptyDataSetVisible) BOOL pa_emptyDataSetVisible;
...
/**
 ...
 @discussion The data source must adopt the PAZNEmptyDataSetSource protocol. The data source is not retained. All data source methods are optional.
 */
@protocol PAZNEmptyDataSetSource <NSObject>
@optional
...
/**
 ...
 @discussion The delegate can adopt the PAZNEmptyDataSetDelegate protocol. The delegate is not retained. All delegate methods are optional.
 
 @discussion All delegate methods are optional. Use this delegate for receiving action callbacks.
 */
@protocol PAZNEmptyDataSetDelegate <NSObject>
@optional

...
@interface UICollectionViewCell (BFAddition)

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wnullability-completeness"
@property (nonatomic, strong) NSIndexPath *em_indexPath;

@property (nonatomic, strong) NSString    *em_identifier;

@end

@interface UICollectionView (BFAddition)
...
- (__kindof UICollectionViewCell *)em_dequeueReusableCellOnlySecionWithIndexPath:(NSIndexPath *)indexPath;
- (__kindof UICollectionViewCell *)em_dequeueReusableCellWithIndexPath:(NSIndexPath *)indexPath;

...
/**
 ...
 Coders
 ------
 A coder must conform to the `PAZNSDImageCoder` protocol or even to `PAZNSDProgressiveImageCoder` if it supports progressive decoding
 ...
 */
@interface PAZNSDImageCodersManager : NSObject <PAZNSDImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) PAZNSDImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<PAZNSDImageCoder>> *coders;
...
/**
 ...
 @param coder coder
 */
- (void)addCoder:(nonnull id<PAZNSDImageCoder>)coder;
...
/**
 ...
 @param coder coder
 */
- (void)removeCoder:(nonnull id<PAZNSDImageCoder>)coder;

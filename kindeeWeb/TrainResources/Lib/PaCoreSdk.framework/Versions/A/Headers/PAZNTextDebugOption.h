...
/**
 The PAZNTextDebugTarget protocol defines the method a debug target should implement.
 ...
 */
- (void)setDebugOption:(nullable PAZNTextDebugOption *)option;
@end



/**
 The debug option for PAZNText.
 */
 ...
 */
+ (void)addDebugTarget:(id<PAZNTextDebugTarget>)target;
...
/**
 ...
 @param target A debug target.
 */
+ (void)removeDebugTarget:(id<PAZNTextDebugTarget>)target;
 ...
 */
+ (nullable PAZNTextDebugOption *)sharedDebugOption;
 ...
 */
+ (void)setSharedDebugOption:(nullable PAZNTextDebugOption *)option;

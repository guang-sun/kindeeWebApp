...
/// Magnifier type
typedef NS_ENUM(NSInteger, PAZNTextMagnifierType) {
    PAZNTextMagnifierTypeCaret,  ///< Circular magnifier
    PAZNTextMagnifierTypeRanged, ///< Round rectangle magnifier
};

/**
 A magnifier view which can be displayed in `PAZNTextEffectWindow`.
...
+ (id)magnifierWithType:(PAZNTextMagnifierType)type;

@property (nonatomic, readonly) PAZNTextMagnifierType type;  ///< Type of magnifier
...
@property (nonatomic) BOOL captureDisabled;               ///< A hint for `PAZNTextEffectWindow` to disable capture.

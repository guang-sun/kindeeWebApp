 ...
 */
- (nullable id<PAZNSDWebImageOperation>)PAZNSD_imageLoadOperationForKey:(nullable NSString *)key;
 ...
 */
- (void)PAZNSD_setImageLoadOperation:(nullable id<PAZNSDWebImageOperation>)operation forKey:(nullable NSString *)key;
 ...
 *  @param key key for identifying the operations
 */
- (void)PAZNSD_cancelImageLoadOperationWithKey:(nullable NSString *)key;
 ...
 *  @param key key for identifying the operations
 */
- (void)PAZNSD_removeImageLoadOperationWithKey:(nullable NSString *)key;

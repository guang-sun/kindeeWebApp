...
#import "LYSegmentProcotol.h"
#import "LYSeqmentConstants.h"
...
@property (nonatomic, assign) NSInteger                                        selectedIndex; //!< 设置当前显示页面

@property (nonatomic, assign, readonly) NSInteger                              currentIndex; //!< 当前显示页面序号

@property (nonatomic, assign) BOOL                                             isShowIndicator; //!< 是否显示主列表滑动条

@property (nonatomic, assign) BOOL                                             isHideSegmentBarWhenSingle; //!< 当只有一个tab页时，是否自动隐藏segmentbar
...
- (LYSMSubBaseViewController *)currentChildViewController;

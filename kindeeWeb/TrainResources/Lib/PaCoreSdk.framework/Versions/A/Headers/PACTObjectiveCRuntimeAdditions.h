...
typedef void(^PACTMethodEnumertor)(Class class, Method method);
typedef BOOL(^PACTClassTest)(Class subclass);
 ...
 */
void class_enumerateMethodList(Class class, PACTMethodEnumertor enumerator);

/**
 @return A subclass of class which passes test.
 */
Class class_subclassPassingTest(Class class, PACTClassTest test);

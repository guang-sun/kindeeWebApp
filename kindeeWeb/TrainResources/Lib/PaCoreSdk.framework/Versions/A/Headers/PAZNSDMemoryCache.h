...
@class PAZNImageCacheConfig;
/**
 A protocol to allow custom memory cache used in PAZNImageCache.
 */
@protocol PAZNSDMemoryCache <NSObject>
 ...
 */
- (nonnull instancetype)initWithConfig:(nonnull PAZNImageCacheConfig *)config;
 ...
 */
@interface PAZNSDMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType> <PAZNSDMemoryCache>

@property (nonatomic, strong, nonnull, readonly) PAZNImageCacheConfig *config;

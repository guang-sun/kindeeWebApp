...
/**
 This category is just use as a convenience method. For more detail control, use methods in `UIImage+MultiFormat.h` or directlly use `PAZNSDImageCoder`.
 */
 ...
 */
+ (nullable UIImage *)PAZNSD_imageWithGIFData:(nullable NSData *)data;

 ...
 */
@interface PAZNSDImageIOAnimatedCoder : NSObject <PAZNSDProgressiveImageCoder, PAZNSDAnimatedImageCoder>

#pragma mark - Subclass Override
/**
 The supported animated image format. Such as `PAZNSDImageFormatGIF`.
 @note Subclass override.
 */
@property (class, readonly) PAZNSDImageFormat imageFormat;
/**
 The supported image format UTI Type. Such as `kUTTypeGIF`.
 This can be used for cases when we can not detect `PAZNSDImageFormat. Such as progressive decoding's hint format `kCGImageSourceTypeIdentifierHint`.
 @note Subclass override.
 */

...
/**
 ...
 Use -[PAZNTextKeyboardManager convertRect:toView:] to convert frame to specified view.
 */
typedef struct {
...
} PAZNTextKeyboardTransition;


/**
 The PAZNTextKeyboardObserver protocol defines the method you can use
 to receive system keyboard change information.
 */
@protocol PAZNTextKeyboardObserver <NSObject>
@optional
- (void)keyboardChangedWithTransition:(PAZNTextKeyboardTransition)transition;
@end


/**
 A PAZNTextKeyboardManager object lets you get the system keyboard information,
 ...
 */
- (void)addObserver:(id<PAZNTextKeyboardObserver>)observer;
 ...
 */
- (void)removeObserver:(id<PAZNTextKeyboardObserver>)observer;

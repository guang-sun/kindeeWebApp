...
@property (atomic, retain) PAZNFMStatement *statement;
...
+ (instancetype)resultSetWithStatement:(PAZNFMStatement *)statement usingParentDatabase:(PAZNFMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(PAZNFMDatabase *)newDb;

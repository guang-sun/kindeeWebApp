...
@class PAAnimatedImage;
@protocol PAAnimatedImageViewDebugDelegate;


//
//  An `PAAnimatedImageView` can take an `PAAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface PAAnimatedImageView : UIImageView
...
@property (nonatomic, strong) PAAnimatedImage *animatedImage;

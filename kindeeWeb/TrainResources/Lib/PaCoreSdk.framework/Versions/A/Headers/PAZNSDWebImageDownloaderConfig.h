...
typedef NS_ENUM(NSInteger, PAZNSDWebImageDownloaderExecutionOrder) {
    /**
     * Default value. All download operations will execute in queue style (first-in-first-out).
     */
    PAZNSDWebImageDownloaderFIFOExecutionOrder,
    
    /**
     * All download operations will execute in stack style (last-in-first-out).
     */
    PAZNSDWebImageDownloaderLIFOExecutionOrder
};
 ...
 */
@interface PAZNSDWebImageDownloaderConfig : NSObject <NSCopying>

/**
 Gets the default downloader config used for shared instance or initialization when it does not provide any downloader config. Such as `PAZNSDWebImageDownloader.sharedDownloader`.
 ...
 */
@property (nonatomic, class, readonly, nonnull) PAZNSDWebImageDownloaderConfig *defaultDownloaderConfig;
...
/**
 * Gets/Sets a subclass of `PAZNSDWebImageDownloaderOperation` as the default
 * `NSOperation` to be used each time PAZNSDWebImage constructs a request
 * operation to download an image.
 * Defaults to nil.
 * @note Passing `NSOperation<PAZNSDWebImageDownloaderOperation>` to set as default. Passing `nil` will revert to `PAZNSDWebImageDownloaderOperation`.
 */
@property (nonatomic, assign, nullable) Class operationClass;

/**
 * Changes download operations execution order.
 * Defaults to `PAZNSDWebImageDownloaderFIFOExecutionOrder`.
 */
@property (nonatomic, assign) PAZNSDWebImageDownloaderExecutionOrder executionOrder;

 ...
 */
@property (nonatomic, assign) BOOL PAZNSD_iPAZNSDecoded;
 ...
 */
+ (nullable UIImage *)PAZNSD_decodedImageWithImage:(nullable UIImage *)image;
 ...
 */
+ (nullable UIImage *)PAZNSD_decodedAndScaledDownImageWithImage:(nullable UIImage *)image;
...
/**
 ...
 @return The decoded and scaled down image
 */
+ (nullable UIImage *)PAZNSD_decodedAndScaledDownImageWithImage:(nullable UIImage *)image limitBytes:(NSUInteger)bytes;

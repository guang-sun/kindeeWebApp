...
#import <PAZNSDWebImage/UIImageView+PAZNWebCache.h>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Here we use the provided pa_setImageWithURL:placeholderImage: method to load the web image
    // Ensure you use a placeholder image otherwise cells will be initialized with no image
    [cell.imageView pa_setImageWithURL:[NSURL URLWithString:@"http://example.com/image.jpg"]
...
/**
 * Integrates PAZNSDWebImage async downloading and caching of remote images with UIImageView.
 */

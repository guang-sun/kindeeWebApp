...
/**
 A protocol to allow custom disk cache used in PAZNImageCache.
 */
@protocol PAZNSDDiskCache <NSObject>
 ...
 */
- (nullable instancetype)initWithCachePath:(nonnull NSString *)cachePath config:(nonnull PAZNImageCacheConfig *)config;
 ...
 */
@interface PAZNSDDiskCache : NSObject <PAZNSDDiskCache>
/**
 Cache Config object - storing all kind of settings.
 */
@property (nonatomic, strong, readonly, nonnull) PAZNImageCacheConfig *config;

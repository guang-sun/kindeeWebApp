...
/**
 ...
 @note If you need to support lower firmware version for HEIF, you can have a try at https://github.com/PAZNSDWebImage/PAZNSDWebImageHEIFCoder
 */
@interface PAZNSDImageHEICCoder : PAZNSDImageIOAnimatedCoder <PAZNSDProgressiveImageCoder, PAZNSDAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) PAZNSDImageHEICCoder *sharedCoder;

...
/**
 This class is used for creating animated images via `animatedImageWithFrames` in `PAZNSDImageCoderHelper`.
 @note If you need to specify animated images loop count, use `PAZNSD_imageLoopCount` property in `UIImage+Metadata.h`.
 */
@interface PAZNSDImageFrame : NSObject

...
#import "PAZNFMDatabase.h"

/**
 Names of commands that can be issued against an FTS table.
 */
extern NSString *const PAZNkFTSCommandOptimize;        // "optimize"
extern NSString *const PAZNkFTSCommandRebuild;         // "rebuild"
extern NSString *const PAZNkFTSCommandIntegrityCheck;  // "integrity-check"
extern NSString *const PAZNkFTSCommandMerge;           // "merge=%u,%u"
extern NSString *const PAZNkFTSCommandAutoMerge;       // "automerge=%u"
...
typedef struct PAZNFMTokenizerCursor
{
...
} PAZNFMTokenizerCursor;

@protocol PAZNFMTokenizerDelegate

- (void)openTokenizerCursor:(PAZNFMTokenizerCursor *)cursor;

- (BOOL)nextTokenForCursor:(PAZNFMTokenizerCursor *)cursor;

- (void)closeTokenizerCursor:(PAZNFMTokenizerCursor *)cursor;
 ...
 */
@interface PAZNFMResultSet (FTS3)
 ...
 */
- (PAZNFMTextOffsets *)offsetsForColumnIndex:(int)columnIdx;

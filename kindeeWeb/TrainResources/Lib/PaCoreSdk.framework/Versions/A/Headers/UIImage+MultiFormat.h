 ...
 */
+ (nullable UIImage *)PAZNSD_imageWithData:(nullable NSData *)data;
...
/**
 ...
 @return The created image
 */
+ (nullable UIImage *)PAZNSD_imageWithData:(nullable NSData *)data scale:(CGFloat)scale;
...
/**
 ...
 @return The created image
 */
+ (nullable UIImage *)PAZNSD_imageWithData:(nullable NSData *)data scale:(CGFloat)scale firstFrameOnly:(BOOL)firstFrameOnly;
 ...
 */
- (nullable NSData *)PAZNSD_imageData;
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)PAZNSD_imageDataAsFormat:(PAZNSDImageFormat)imageFormat NS_SWIFT_NAME(PAZNSD_imageData(as:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)PAZNSD_imageDataAsFormat:(PAZNSDImageFormat)imageFormat compressionQuality:(double)compressionQuality NS_SWIFT_NAME(PAZNSD_imageData(as:compressionQuality:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)PAZNSD_imageDataAsFormat:(PAZNSDImageFormat)imageFormat compressionQuality:(double)compressionQuality firstFrameOnly:(BOOL)firstFrameOnly NS_SWIFT_NAME(PAZNSD_imageData(as:compressionQuality:firstFrameOnly:));

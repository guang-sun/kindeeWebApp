 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `PAZNModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
     ...
     int main() {
         ...
         YYBook *book = [YYBook pa_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
...
+ (NSDictionary *)pa_dictionaryWithJSON:(id)json;
...
+ (nullable NSArray *)pa_modelArrayWithClass:(Class)cls array:(NSArray *)arr;
...
/**
 ...
 There's no need to add '<PAZNModel>' to your class header.
 */
@protocol PAZNModel <NSObject>
@optional

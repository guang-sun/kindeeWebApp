...
/**
 The PAZNTextAsyncLayer class is a subclass of CALayer used for render contents asynchronously.
...
/**
 The PAZNTextAsyncLayer's delegate protocol. The delegate of the PAZNTextAsyncLayer (typically a UIView)
...
/**
 A display task used by PAZNTextAsyncLayer to render the contents in background queue.
 */

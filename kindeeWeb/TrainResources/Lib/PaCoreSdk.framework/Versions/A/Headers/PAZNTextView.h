...
/**
 The PAZNTextViewDelegate protocol defines a set of optional methods you can use
 to receive editing-related messages for PAZNTextView objects. 
...
@optional
- (BOOL)textViewShouldBeginEditing:(PAZNTextView *)textView;
- (BOOL)textViewShouldEndEditing:(PAZNTextView *)textView;
- (void)textViewDidBeginEditing:(PAZNTextView *)textView;
- (void)textViewDidEndEditing:(PAZNTextView *)textView;
- (BOOL)textView:(PAZNTextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text;
- (void)textViewDidChange:(PAZNTextView *)textView;
- (void)textViewDidChangeSelection:(PAZNTextView *)textView;

- (BOOL)textView:(PAZNTextView *)textView shouldTapHighlight:(PAZNTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(PAZNTextView *)textView didTapHighlight:(PAZNTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
- (BOOL)textView:(PAZNTextView *)textView shouldLongPressHighlight:(PAZNTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(PAZNTextView *)textView didLongPressHighlight:(PAZNTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;

- (void)textViewResetInputView:(PAZNTextView *)textView;
@end
...
/**
 The PAZNTextView class implements the behavior for a scrollable, multiline text region.
 ...
 * It allows to set an attributed text as placeholder.
 ...
 See NSAttributedString+PAZNText.h for more convenience methods to set the attributes.
 See PAZNTextAttribute.h and PAZNTextLayout.h for more information.
 */
@interface PAZNTextView : UIScrollView <UITextInput>
...
@property (nullable, nonatomic, weak) id<PAZNTextViewDelegate> delegate;
...
/**
 The text vertical aligmnent in container. Default is PAZNTextVerticalAlignmentTop.
 */
@property (nonatomic) PAZNTextVerticalAlignment textVerticalAlignment;
...
/**
 ...
 @discussion It only support the attributes declared in CoreText and PAZNTextAttribute.
 See `NSAttributedString+PAZNText` for more convenience methods to set the attributes.
 */
...
/**
 ...
 See `PAZNTextParser` protocol for more information.
 */
@property (nullable, nonatomic, strong) id<PAZNTextParser> textParser;

/**
 The current text layout in text view (readonly).
 It can be used to query the text layout information.
 */
@property (nullable, nonatomic, strong, readonly) PAZNTextLayout *textLayout;
...
/**
 ...
 See `PAZNTextLinePositionModifier` protocol for more information.
 */
@property (nullable, nonatomic, copy) id<PAZNTextLinePositionModifier> linePositionModifier;

/**
 The debug option to display CoreText layout result.
 The default value is [PAZNTextDebugOption sharedDebugOption].
 */
@property (nullable, nonatomic, copy) PAZNTextDebugOption *debugOption;
...
/**
 The current selection range of the receiver.
 */
@property (nonatomic) BOOL disableSelectAllRangeAfterTextChanged;
 ...
 */
@property (nullable, nonatomic, readwrite, strong) UIView *inputView;
...
@property (nonatomic) IBInspectable PAZNTextVerticalAlignment textVerticalAlignment;
...
UIKIT_EXTERN NSString *const PAZNTextViewTextDidBeginEditingNotification;
UIKIT_EXTERN NSString *const PAZNTextViewTextDidChangeNotification;
UIKIT_EXTERN NSString *const PAZNTextViewTextDidEndEditingNotification;

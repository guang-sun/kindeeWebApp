...
#ifdef __OBJC_GC__
    #error PAZNSDWebImage does not support Objective-C Garbage Collection
#endif
...
// Note: watchOS also has UIKit, but it's very limited
    ...
    #define PAZNSD_UIKIT 1
#else
    #define PAZNSD_UIKIT 0
#endif
...
#if TARGET_OS_WATCH
    #define PAZNSD_WATCH 1
#else
    #define PAZNSD_WATCH 0
#endif

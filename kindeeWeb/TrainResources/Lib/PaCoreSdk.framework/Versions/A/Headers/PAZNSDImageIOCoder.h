...
/**
 ...
 For a full GIF support, we recommend `PAZNSDAnimatedImageView` to keep both CPU and memory balanced.
 ...
 */
@interface PAZNSDImageIOCoder : NSObject <PAZNSDProgressiveImageCoder>

@property (nonatomic, class, readonly, nonnull) PAZNSDImageIOCoder *sharedCoder;

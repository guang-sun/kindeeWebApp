...
@implementation UIImage (imageFace)
...
+(UIImage*)pixelBufferToImage:(CVPixelBufferRef) pixelBufffer{
    ...
    if (width > height) {
        ...
        imagewidth = height;
        rect = CGRectMake((width- imagewidth) /2, 0 , imagewidth, imagewidth);

    }else {
        imagewidth = width ;
        rect = CGRectMake(0, (height - imagewidth) /2 , imagewidth, imagewidth);
    }
...
//    }
//
//    CGImageRef cgImage = CGImageCreate(imagewidth,
//                                       imagewidth,
//                                       kBitsPerComponent,
//                                       kBitsPerPixel,
//                                       bytesPerRow,

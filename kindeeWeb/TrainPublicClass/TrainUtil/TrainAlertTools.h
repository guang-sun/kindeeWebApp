 ...
 *  弹框显示的时间，默认2秒
 */
#define TrainAlertViewShowTime 2
 ...
 */
#define TrainEmptyTitle iOS_Version >= 7.0 ? @"" : @" "
 ...
 */
typedef enum {
    TrainAlertActionStyleDefault = 0,
    TrainAlertActionStyleCancel,
    TrainAlertActionStyleDestructive
}TrainAlertActionStyle;



@interface TrainAlertTools : NSObject
